...
Shader "Black Sun shader"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float temp_output_56_0 = ( temp_output_42_0 * (3.0 + (sin( ( ( _Time.y + 2.0 ) / 8.0 ) ) - -1.0) * (7.2 - 3.0) / (1.0 - -1.0)) );
...
/*ASEBEGIN
Version=15401
0;73;482;804;1015.67;-3117.573;1;False;False
...
Node;AmplifyShaderEditor.RangedFloatNode;184;-1351.771,3695.985;Float;False;Constant;_Float31;Float 31;8;0;Create;True;0;0;False;0;8;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;186;-782.8086,3506.288;Float;False;Constant;_Float32;Float 32;11;0;Create;True;0;0;False;0;3;0;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=CD537ABC28FAB737F2048992A4D4C78626136D56