...
{
    private int NOMBRE_DE_TILE_LARGE = 3;           // nombre de tiles à instancier sur une même ligne
    private int NOMBRE_DE_TILE_LONG = 4;            // nombre de tiles instenciées sur la longueur 
